...
public:
   ...
   * The local address.
   */
  virtual const Network::Address::InstanceConstSharedPtr& localAddr() const PURE;
...
public:
   ...
   * @param local_addr is the local address.
  ...
  decode(Buffer::Instance& data, const Network::Address::InstanceConstSharedPtr& from, const Network::Address::InstanceConstSharedPtr& local_addr) PURE;
};
