...
#include "extensions/filters/listener/dns/dns_codec_impl.h"
...
// Begin MessageImpl
DecoderImpl::MessageImpl::MessageImpl(const Network::Address::InstanceConstSharedPtr& from, const Network::Address::InstanceConstSharedPtr& local_addr)
    : from_(from), local_addr_(local_addr), header_(), question_(), answers_() {}

DecoderImpl::MessageImpl::MessageImpl(const MessageImpl& request_message)
    : from_(request_message.from()), local_addr_(request_message.localAddr()),
      header_(request_message.header_), question_(request_message.question_), answers_() {}

const Network::Address::InstanceConstSharedPtr& DecoderImpl::MessageImpl::from() const {
  return from_;
}

const Network::Address::InstanceConstSharedPtr& DecoderImpl::MessageImpl::localAddr() const {
  return local_addr_;
}
...
DecoderImpl::decode(Buffer::Instance& data, const Network::Address::InstanceConstSharedPtr& from, const Network::Address::InstanceConstSharedPtr& local_addr) {
  ...
  MessageImpl* message = new MessageImpl(from, local_addr);
