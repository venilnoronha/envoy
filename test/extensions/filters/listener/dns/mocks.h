...
public:
  MockMessage(Network::Address::InstanceConstSharedPtr& from, Network::Address::InstanceConstSharedPtr& local_addr);
  ~MockMessage();

  // Formats::Message
  MOCK_CONST_METHOD0(from, Network::Address::InstanceConstSharedPtr&());
  MOCK_CONST_METHOD0(localAddr, Network::Address::InstanceConstSharedPtr&());
