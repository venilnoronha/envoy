...
public:
  ...
  decode(Buffer::Instance& data, const Network::Address::InstanceConstSharedPtr& from, const Network::Address::InstanceConstSharedPtr& local_addr) override;
...
private:
  ...
  public:
    MessageImpl(const Network::Address::InstanceConstSharedPtr& from, const Network::Address::InstanceConstSharedPtr& local_addr);
    MessageImpl(const MessageImpl& request_message);

    // Formats::Message
    const Network::Address::InstanceConstSharedPtr& from() const override;
    const Network::Address::InstanceConstSharedPtr& localAddr() const override;
  ...
  private:
    ...
    const Network::Address::InstanceConstSharedPtr local_addr_;
